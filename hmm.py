...
sampling_freq, audio = wavfile.read("audio/cough/77157__kyster__cough.wav")
...
category_list = ["cough","maybe_cough"]
for idx ,category in enumerate(category_list): 
  example_data_path = 'audio/' + category
  ...
  plt.yscale('linear')
  plt.matshow((mfcc_features.T)[:,:300],0)
  plt.text(150, -50, category, horizontalalignment='center', fontsize=20)
